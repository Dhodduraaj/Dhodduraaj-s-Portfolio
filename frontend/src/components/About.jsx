          ...
          >
            ...
            <div className="space-y-5 pt-6 flex-grow">
              ...
              <p className="text-sm font-black text-slate-750 dark:text-slate-350 leading-relaxed">
                Rather than relying on templated designs, I prefer constructing custom mechanical frames, writing normalized entity mapping tables, and slinging responsive responsive code widgets.
              </p>
            </div>
